...
document.getElementById('odontologo-form').addEventListener('submit', async function(event) {
    ...
    let userData = jsonDataOdontologo.nombre + " " + jsonDataOdontologo.apellido;    
